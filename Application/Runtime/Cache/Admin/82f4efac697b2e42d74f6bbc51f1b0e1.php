...
<h1>
    ...
    <span class="action-span1"><a href="__Module__/Index/index">ECSHOP 管理中心</a></span>
    <span id="search_id" class="action-span1"> - 添加管理员 </span>
    <div style="clear:both"></div>
</h1>
<div class="main-div">
    <form action="/index.php/Admin/Admin/add" method="post" name="theForm">
        <table width="100%" id="general-table">
			...
			<tr>
                ...
                <td>
                    <input type='password' name='rpassword' maxlength="20" value='' size='27' /> <font color="red">*</font>
                </td>
            </tr>
        </table>
